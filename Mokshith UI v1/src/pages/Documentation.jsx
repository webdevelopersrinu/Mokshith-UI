...
export default function Documentation() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 text-gray-900">
      {/* Sidebar */}
      <aside className="w-full md:w-64 h-full    p-4 md:h-full">
        <nav className="mt-4">
          <ul>
            <li className="py-2 text-gray-900 font-bold ">Getting Started</li>
            <li className="py-2 text-gray-700 hover:text-blue-500">
              Introduction
            </li>
            <li className="py-2 text-gray-700 hover:text-blue-500">
              Installation
            ...
            <li className="py-2 text-gray-900 font-bold ">Components</li>
            ...
            <li className="py-2 text-gray-900 font-bold ">Advanced Topics</li>
            <li className="py-2 text-gray-700 hover:text-blue-500">
              Accessibility
            </li>
            <li className="py-2 text-gray-700 hover:text-blue-500">
      ...
      <main className="flex-1 p-6 bg-white border border-t-0 border-b-0 border-r-gray-200">
        ...
        <section className="mt-6">
          ...
          <p className="text-gray-700 mt-2">
            Mokshith UI is a collection of beautifully designed, accessible UI
            components. No Installation needed—just copy the code and start
            using it in your Tailwind CSS projects.
          </p>
